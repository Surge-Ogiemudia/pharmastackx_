    ...
    <>
      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          <div className={styles.pharmacyBrand}>
            <div className={styles.pharmacyAvatar}>SC</div>
            <div>
              <div className={styles.pharmacyName}>{slug ? slug.replace(/-/g, ' ').toUpperCase() : 'Surge Central Pharmacy'}</div>
              <div className={styles.pharmacyMeta}>
                <span className={styles.statusDot}></span>
                Open now {userLocation ? '· Nearby' : ''}
              </div>
            </div>
          </div>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroText}>
            <div className={styles.heroEyebrow}>Verified pharmacy · psx.ng</div>
          ...
          <div className={styles.infoItems}>
            <div className={styles.infoItem}>
              ...
              <div className={styles.infoText}>
                ...
                <div className={styles.infoValue}>Delivery & Pickup</div>
              </div>
            </div>
            <div className={styles.infoItem}>
              <div className={styles.infoIcon}>🕐</div>
              <div className={styles.infoText}>
                <div className={styles.infoLabel}>Hours today</div>
                <div className={styles.infoValue}>8:00 AM — 9:00 PM</div>
              </div>
            </div>
          </div>
          <Link href="/?view=orderMedicines">
            <button className={styles.requestBtn}>Search by Prescription →</button>
          </Link>
        </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <div>
            <div className={styles.footerBrand}>Surge Central <span>Pharmacy</span></div>
            <div className={styles.footerText} style={{ marginTop: '4px' }}>Licensed by PCN</div>
          </div>
          <div className={styles.psxBadge}>
            Powered by <strong>PharmaStackX</strong>
          </div>
        </div>
      </footer>
